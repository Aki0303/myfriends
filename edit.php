<?php
  ...
  // ②受け取ったパラメータに紐づく友達のデータと取得するSQL文作成
      ...
      <div class="col-md-4 content-margin-top">
        ...
        <form method="post" action="edit.php?friend_id=<?php echo $friends['friend_id']; ?>" class="form-horizontal" role="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="name" class="form-control" placeholder="<?php echo $editName; ?>" required value=<?php echo $friends['friend_name']; ?>>
              </div>
            </div>
            <!-- 出身 -->
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="age" class="form-control" placeholder="<?php echo $editAge; ?>" required value=<?php echo $friends['age']; ?>>
              </div>
            </div>
