<?php
  ...
  // ②SQLを作成
  $sql = 'SELECT `areas`.`area_id`, `areas`.`area_name`, COUNT(`friend_id`) AS friends_cnt FROM `areas` LEFT JOIN `friends` ON `areas`.`area_id` = `friends`. `area_id` GROUP BY `areas`.`area_id` , `areas`.`area_name` ORDER BY `areas`.`area_id`';
